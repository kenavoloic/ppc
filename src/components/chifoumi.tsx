...
const Chifoumi: Etats = ({valeurs}) => {
  ...
  <ToggleGroupItem value="0" data-state={papierJoueur ? "on" : "off"} aria-checked={papierJoueur ? "on" : "off"} className="bg-red-500">
            <Image src="/images/svg/a_papier.svg" alt="Papier"  width={40} height={40} />
           </ToggleGroupItem>
           <ToggleGroupItem value="1" data-state={pierreJoueur ? "on" : "off"} aria-checked={pierreJoueur ? "on" : "off"} className="bg-red-500">
            <Image src="/images/svg/a_pierre.svg" alt="Pierre"  width={40} height={40} />
           </ToggleGroupItem>
           <ToggleGroupItem value="2" data-state={ciseauxJoueur ? "on" : "off"} aria-checked={ciseauxJoueur ? "on" : "off"} className="bg-red-500">
